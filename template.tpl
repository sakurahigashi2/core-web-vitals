...

{
  ...
  "version": 1.1,
  "securityGroups": [],
  "displayName": "Core Web Vitals改",
  "categories": [
    "UTILITY"
  ],
  "__wm": "VGVtcGxhdGUtQXV0aG9yX0NvcmVXZWJWaXRhbHMtU2ltby1BaGF2YQ\u003d\u003d",
  "brand": {
    "id": "github.com/sakurahigashi2/core-web-vitals",
    "displayName": "gtm-templates-simo-ahava & sakurahigashi2",
  ...
  "description": "Load the Core Web Vitals library from a CDN and have it push key milestones (CLS, FID, LCP, FCP, INP, TTFB) into dataLayer for use in tags.",
  "containerContexts": [
    "WEB"
  ]
}
...
const process = obj => {
  ...
  const cwvObj = {
    ...
    attribution: JSON.stringify(obj.attribution ? obj.attribution : {}),
  };
  log(cwvObj);
  if (data.namespace) {
...
// Load the library
injectScript('https://unpkg.com/web-vitals@3/dist/web-vitals.attribution.iife.js', setMilestones, data.gtmOnFailure, 'web-vitals');
      ...
      "param": [
        {
          ...
          "value": {
            ...
            "listItem": [
              {
                "type": 1,
                "string": "https://unpkg.com/web-vitals@3/dist/web-vitals.attribution.iife.js"
              }
            ]
          }
        }
